...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFF0F0F0F);
  late Color primaryBackground = const Color(0xFFBCBCBC);
  late Color secondaryBackground = const Color(0xFFE5E5E5);
  late Color accent1 = const Color(0xFFFFFFFF);
  late Color accent2 = const Color(0x4D202020);
  late Color accent3 = const Color(0xF0000000);
  late Color accent4 = const Color(0xFF229C97);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFAAB15);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryBackground = const Color(0xFF57636C);
  late Color accent1 = const Color(0xFF1D2428);
  late Color accent2 = const Color(0xFFDDE0E1);
  late Color accent3 = const Color(0xF0FFFFFF);
  late Color accent4 = const Color(0xFF229C97);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFAAB15);
