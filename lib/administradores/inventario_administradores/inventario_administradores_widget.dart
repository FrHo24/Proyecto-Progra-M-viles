import '/administradores/editar_admin/editar_admin_widget.dart';
import '/administradores/eliminar_admin/eliminar_admin_widget.dart';
...
class _InventarioAdministradoresWidgetState
  ...
  void initState() {
    ...
    _model.txtANombreAdminTextController ??= TextEditingController();
    _model.txtANombreAdminFocusNode ??= FocusNode();

    _model.txtAApellidosAdminTextController ??= TextEditingController();
    _model.txtAApellidosAdminFocusNode ??= FocusNode();

    _model.txtACorreoAdminTextController ??= TextEditingController();
    _model.txtACorreoAdminFocusNode ??= FocusNode();

    _model.txtACedulaAdminTextController ??= TextEditingController();
    _model.txtACedulaAdminFocusNode ??= FocusNode();

    _model.txtATelefonoAdminTextController ??= TextEditingController();
    _model.txtATelefonoAdminFocusNode ??= FocusNode();
  }
