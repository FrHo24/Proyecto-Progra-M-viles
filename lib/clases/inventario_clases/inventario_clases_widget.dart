...
import '/clases/editar_clase/editar_clase_widget.dart';
import '/clases/eliminar_clase/eliminar_clase_widget.dart';
...
class _InventarioClasesWidgetState extends State<InventarioClasesWidget> {
  ...
  void initState() {
    ...
    _model.txtNClaseTextController ??= TextEditingController();
    _model.txtNClaseFocusNode ??= FocusNode();

    _model.txtDClaseTextController ??= TextEditingController();
    _model.txtDClaseFocusNode ??= FocusNode();

    _model.txtInstructorTextController ??= TextEditingController();
    _model.txtInstructorFocusNode ??= FocusNode();

    _model.txtCClaseTextController ??= TextEditingController();
    _model.txtCClaseFocusNode ??= FocusNode();
  }
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      validator: _model
                                                          .txtNClaseTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      validator: _model
                                                          .txtDClaseTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .txtInstructorTextController,
                                                      focusNode: _model
                                                          .txtInstructorFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                                                        labelText:
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                          's36htil0' /* Intructor que la imparte... */,
                                                        ),
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                      ...
                                                      validator: _model
                                                          .txtInstructorTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      validator: _model
                                                          .txtCClaseTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
