...
import '/principal/productos/editar_producto/editar_producto_widget.dart';
import '/principal/productos/eliminar_producto/eliminar_producto_widget.dart';
...
class _InventarioProductosWidgetState extends State<InventarioProductosWidget> {
  ...
  void initState() {
    ...
    _model.txtANombreProductosTextController ??= TextEditingController();
    _model.txtANombreProductosFocusNode ??= FocusNode();

    _model.txtADescripcionProductoTextController ??= TextEditingController();
    _model.txtADescripcionProductoFocusNode ??= FocusNode();

    _model.txtAPrecioProductoTextController ??= TextEditingController();
    _model.txtAPrecioProductoFocusNode ??= FocusNode();

    _model.txtACantProductoTextController ??= TextEditingController();
    _model.txtACantProductoFocusNode ??= FocusNode();

    _model.txtACategoriaProductoTextController ??= TextEditingController();
    _model.txtACategoriaProductoFocusNode ??= FocusNode();
  }
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .txtANombreProductosTextController,
                                                      focusNode: _model
                                                          .txtANombreProductosFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .txtADescripcionProductoTextController,
                                                      focusNode: _model
                                                          .txtADescripcionProductoFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .txtAPrecioProductoTextController,
                                                      focusNode: _model
                                                          .txtAPrecioProductoFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .txtACantProductoTextController,
                                                      focusNode: _model
                                                          .txtACantProductoFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .txtACategoriaProductoTextController,
                                                      focusNode: _model
                                                          .txtACategoriaProductoFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                                                ...
                                                Expanded(
                                                  child: StreamBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<ProveedoresRecord>
                                                          btnAgregarProductoProveedoresRecordList =
                                                          snapshot.data!;
                                                      ...
                                                      final btnAgregarProductoProveedoresRecord =
                                                          btnAgregarProductoProveedoresRecordList
                                                                  .isNotEmpty
                                                              ? btnAgregarProductoProveedoresRecordList
                                                                  .first
                                                              ...
                                                              .set(
                                                                ...
                                                                categoriaProducto:
                                                                    _model
                                                                        ...
                                                                        .text,
                                                                proveedorProductos:
                                                                    btnAgregarProductoProveedoresRecord
                                                                        ?.reference,
                                                              ));
