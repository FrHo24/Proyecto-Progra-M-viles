                    ...
                    StreamBuilder<List<InstructoresRecord>>(
                      stream: queryInstructoresRecord(
                        queryBuilder: (instructoresRecord) =>
                            instructoresRecord.orderBy('nombreInstructor'),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        List<InstructoresRecord>
                            ddInstructorInstructoresRecordList = snapshot.data!;

                        return FlutterFlowDropDown<String>(
                          controller: _model.ddInstructorValueController ??=
                              FormFieldController<String>(
                            _model.ddInstructorValue ??=
                                FFLocalizations.of(context).getText(
                              '116qcb2w' /* Intructor */,
                            ),
                          ),
                          options: ddInstructorInstructoresRecordList
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'og6a5fkr' /* Seleccione un Instructor */,
                          ),
                          icon: Icon(
                            Icons.keyboard_arrow_down_rounded,
                            color: FlutterFlowTheme.of(context).secondaryText,
                ...
                StreamBuilder<List<InstructoresRecord>>(
                  stream: queryInstructoresRecord(
                    queryBuilder: (instructoresRecord) =>
                      ...
                      'nombreInstructor',
                      isEqualTo: _model.ddInstructorValue,
                    ),
                    singleRecord: true,
                  ),
                  builder: (context, snapshot) {
