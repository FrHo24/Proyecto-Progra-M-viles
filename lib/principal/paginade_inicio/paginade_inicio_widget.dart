...
import 'paginade_inicio_model.dart';
export 'paginade_inicio_model.dart';

class PaginadeInicioWidget extends StatefulWidget {
  const PaginadeInicioWidget({super.key});

  @override
  State<PaginadeInicioWidget> createState() => _PaginadeInicioWidgetState();
}

class _PaginadeInicioWidgetState extends State<PaginadeInicioWidget>
    with TickerProviderStateMixin {
  late PaginadeInicioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaginadeInicioModel());
                      ...
                      Align(
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            Tab(
                              text: FFLocalizations.of(context).getText(
                                'eszqofps' /* Administrador */,
                              ),
                            ),
                            Tab(
                              text: FFLocalizations.of(context).getText(
                                'rtmm2zns' /* Instructores */,
                              ),
                            ),
                            Tab(
                              text: FFLocalizations.of(context).getText(
