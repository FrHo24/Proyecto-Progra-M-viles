// Export pages
export '/principal/login/login_widget.dart' show LoginWidget;
...
export '/principal/inventarios/proveedores/inventario_proveedores/inventario_proveedores_widget.dart'
    show InventarioProveedoresWidget;
export '/principal/inventarios/equipo/inventario_equipo/inventario_equipo_widget.dart'
    show InventarioEquipoWidget;
export '/principal/inventarios/clases/inventario_clases/inventario_clases_widget.dart'
    show InventarioClasesWidget;
export '/principal/inventarios/clientes/inventario_clientes/inventario_clientes_widget.dart'
...
export '/principal/login_perfil/sobre_nosotros/sobre_nosotros_widget.dart'
